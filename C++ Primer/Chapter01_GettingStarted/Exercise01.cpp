...
void ex_16(){
    // C++Primer练习1.16：编写程序，从cin读取一组数，输出其和
    std::cout << "C++Primer练习1.16：编写程序，从cin读取一组数，输出其和。请输入第一个数字：" << std::endl;
    int sum16 = 0, input16 = 0;
    while (std::cin >> input16)
    {
        sum16 += input16;
        std::cout << "目前的总和为：" << sum16 << "，请输入下一个数字" << std::endl;
    }
    std::cout << "程序结束，总和为：" << sum16 << std::endl;
    std::cout << "=============================================================" << std::endl;
}
